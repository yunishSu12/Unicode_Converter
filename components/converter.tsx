      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          ...
          <Textarea
            ...
            style={mode === 'preetiToUnicode' ? { fontFamily: 'Preeti, monospace', fontSize: '22px', lineHeight: '1.3', letterSpacing: '-0.3px', wordSpacing: '-3px' } : { fontFamily: 'monospace' }}
        ...
        <div className="space-y-3">
          ...
          <Textarea
            ...
            style={mode === 'unicodeToPreeti' ? { fontFamily: 'Preeti, monospace', fontSize: '22px', lineHeight: '1.3', letterSpacing: '-0.3px', wordSpacing: '-3px' } : { fontFamily: 'monospace' }}
